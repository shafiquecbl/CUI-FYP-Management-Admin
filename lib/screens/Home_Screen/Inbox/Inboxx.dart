...
import 'package:fyp_management/screens/Home_Screen/Inbox/chat_screen.dart';
import 'package:fyp_management/screens/Home_Screen/Inbox/teacher_Chat_Screen.dart';
          ...
          children: <Widget>[
            Container(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    '${(snapshot['RegNo'].trim().split(' ').first)[0]}${(snapshot['RegNo'].trim().trimLeft().split(' ').last)[0]}',
                    style: GoogleFonts.teko(
                      color: kPrimaryColor,
                      fontSize: 30,
                    ),
